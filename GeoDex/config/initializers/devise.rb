...
Devise.setup do |config|
  ...
  # config.pepper = "a90b0c8771ab736031b7b5b0b41826fb426db2357043198831a9174f20a0016c74e27f439c5e8fd31f7b690b6e13772b3b10c53dfa3c41beeb564185762d7be4"
  ...
  if Rails.env == "development"
    ...
    OmniAuth.config.full_host = 'http://geodex.hk'
  end
end
